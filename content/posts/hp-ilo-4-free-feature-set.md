...
*   You can see the values of the various sensors on the system: fan speed, temperatures. There's even a fun visualization: [![](/images/microserver-gen8-temps.png)](/images/microserver-gen8-temps.png)
